...
func (x *MessageX) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageX) ProtoMessage() {}

func (x *MessageX) ProtoReflect() protoreflect.Message {
	mi := &file_sample_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageX.ProtoReflect.Descriptor instead.
func (*MessageX) Descriptor() ([]byte, []int) {
	return file_sample_proto_rawDescGZIP(), []int{1}
}

func (x *MessageX) GetBody() string {
	if x != nil {
		return x.Body
	}
	return ""
...
var file_sample_proto_rawDesc = []byte{
	...
	,
}
...
var file_sample_proto_goTypes = []interface{}{
	(*Message)(nil),  // 0: sample.Message
	(*MessageX)(nil), // 1: sample.MessageX
}
var file_sample_proto_depIdxs = []int32{
	0, // 0: sample.SampleService.GetData:input_type -> sample.Message
	1, // 1: sample.SampleService.GetData:output_type -> sample.MessageX
